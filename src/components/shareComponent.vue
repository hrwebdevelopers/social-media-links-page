<template>
  <div class="float-container">
    <a class="share-btn" @click="show = !show">
      <fa-icon icon="fa-solid fa-share-alt" />
    </a>
  </div>

  <div class="dialog-container" v-if="true">
    <div class="dialog">
      ...
      <div class="dialog-body">
        ...
        <div class="card-link-copy" @click.prevent="onCopy()">
          ...
          <div>
            <fa-icon class="copy-icon" icon="fa-solid fa-solid fa-copy" />
            {{ copyTxt }}
          </div>
        </div>
...
.card-link-copy {
  ...
  background: #f1f1f1;
  box-shadow: .250rem .250rem .5rem #bebebe,
    -.250rem -.250rem .5rem #ffffff;
  transition: all 0.3s ease-in-out;
  cursor: pointer;
}
